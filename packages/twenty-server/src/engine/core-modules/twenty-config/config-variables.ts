...
export class ConfigVariables {
  ...
  @ConfigVariablesMetadata({
    group: ConfigVariablesGroup.ADVANCED_SETTINGS,
    description: 'Enable Permavent application-level record security hooks',
    isEnvOnly: true,
    isHiddenInAdminPanel: true,
    type: ConfigVariableType.BOOLEAN,
  })
  @IsOptional()
  PERMAVENT_SECURITY_RLS_ENABLED = false;
  ...
  @ConfigVariablesMetadata({
    group: ConfigVariablesGroup.ADVANCED_SETTINGS,
    description:
      'Expand the Permavent My Companies view marker for active Sales Rep assignments',
    isEnvOnly: true,
    isHiddenInAdminPanel: true,
    type: ConfigVariableType.BOOLEAN,
  })
  @IsOptional()
  PERMAVENT_MY_COMPANIES_FOCUS_ENABLED = false;
