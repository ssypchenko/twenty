export enum FeatureFlagKey {
  ...
  IS_PERMAVENT_COMPANY_WIDE_SIDE_PANEL_ENABLED = 'IS_PERMAVENT_COMPANY_WIDE_SIDE_PANEL_ENABLED',
  IS_PERMAVENT_COMPANY_OVERVIEW_WIDGETS_ENABLED = 'IS_PERMAVENT_COMPANY_OVERVIEW_WIDGETS_ENABLED',
